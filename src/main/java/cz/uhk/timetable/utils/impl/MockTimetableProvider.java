...
public class MockTimetableProvider implements TimetableProvider {
    ...
    public LocationTimetable read(String building, String room) {
        ...
        var activities = List.of(
            new Activity("PRO1", "Programovani 1", "utery",
                    LocalTime.of(12,25), LocalTime.of(13, 55), "Kozel"),
            new Activity("OS1A", "Operacni Systemy 1", "streda",
                    LocalTime.of(14,50), LocalTime.of(16, 25), "Almer"),
            new Activity("ZMI2", "Zaklady Matematiky 2", "pondeli",
                    LocalTime.of(11,35), LocalTime.of(13, 10), "Bauer")
        );
